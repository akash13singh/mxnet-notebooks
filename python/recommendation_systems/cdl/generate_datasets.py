...
def create_training_test_sets(P=10,n=5551):
    ...
    for user_id in range(num_users):
        ...
        train_idx = random.sample(xrange(num_articles),10)
...
def generate_datasets(num_samples,num_sets=1,setting="dense",):
    ...
    for i in range(num_sets):
        ...
        trainFile = "train"+str(i+1)+".dat"
        testFile = "test" + str(i+1)+".dat"
...
if __name__ == '__main__':
    generate_datasets(num_samples=5551,num_sets=4,setting="dense")
